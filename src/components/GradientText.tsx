...
export default function GradientText({
    ...
    return (
        ...
        >
            {showBorder && (
                <div
                    className="absolute inset-0 bg-cover z-0 pointer-events-none animate-wiggle"
                    style={{
                        ...gradientStyle,
            ...
            <div
                className="inline-block relative z-2 text-transparent bg-transparent bg-cover animate-wiggle"
                style={{
                    ...gradientStyle,
                    backgroundClip: "text",
